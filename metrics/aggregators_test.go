...
func TestAvgGauge(t *testing.T) {
	...
	t.Run("TestAvgGaugeUpdate", func(t *testing.T) {
		...
		if record.Metrics().Policy() != PolicyAvg {
			t.Errorf("Expected policy PolicyAvg, got %v", record.Metrics().Policy())
		}
		if record.cnt != 1 {
...
func TestMaxGauge(t *testing.T) {
	...
	t.Run("TestMaxGaugeUpdate", func(t *testing.T) {
		...
		if record.Metrics().Policy() != PolicyMax {
			t.Errorf("Expected policy PolicyMax, got %v", record.Metrics().Policy())
		}
	})
...
func TestMinGauge(t *testing.T) {
	...
	t.Run("TestMinGaugeUpdate", func(t *testing.T) {
		...
		if record.Metrics().Policy() != PolicyMin {
			t.Errorf("Expected policy PolicyMin, got %v", record.Metrics().Policy())
		}
	})
