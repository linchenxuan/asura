...
// NewTextMapCarrier creates a new thread-safe text map carrier
// Returns a Carrier implementation that uses a map for storage
...
// Returns a slice containing all keys in no particular order
...
// Returns "text_map" for this implementation
func (c *textMapCarrier) Format() string {
	return "text_map"
}
